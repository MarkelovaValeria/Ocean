        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimalName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    AnimalDescription = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionEmployer = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    PathPhoto = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionProduct = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
